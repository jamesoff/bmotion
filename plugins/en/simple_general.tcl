...
bMotion_plugin_add_simple "seven" {^7[?!.]?$} 40 [list "7!" "7 %SMILEY{smile}" "wh%REPEAT{3:7:e} 7!"] "en"
bMotion_plugin_add_simple "mmm" "mmm+ $botnicks" 25 "%SMILEY{smile}" "en"
...
bMotion_plugin_add_simple "cunt" "^(cunt|twat|bollocks|fuck|shit)$" 80 [list "cunt" "twat" "bollocks" "bastards" "idiot" "wanker" "%VAR{prom_first}" "pile of %VAR{prom_first}" "%VAR{prom_first}ing %VAR{prom_first}ers"] "en"
