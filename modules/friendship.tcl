...
proc setFriendship { nick friendship } {
  ...
  if {$friendship < 0} {
    bMotion_putloglev 2 * "bMotion: friendship for $nick went under 0, capping back to 10"
    set friendship 10
  }
...
proc driftFriendship { nick drift } {
  if {![validuser $nick]} {
    ...
    bMotion_putloglev 1 * "bMotion: mmm dynamic update of nick $nick to handle $handle :P"
    set nick $handle
  }
