...
proc bMotion_module_extra_dutchify_makeDutch { line } {
  ...
  #i -> ik
  set line [bMotion_module_extra_dutchify_single_word_replace i ik $line]
  set line [bMotion_module_extra_dutchify_single_word_replace "(is|am) called" "heet" $line]
  regsub -nocase -all {[[:<:]]a(n)?[[:>:]]} $line {een} line
  set line [bMotion_module_extra_dutchify_single_word_replace it het $line]
  set line [bMotion_module_extra_dutchify_single_word_replace am ben $line]
  set line [bMotion_module_extra_dutchify_single_word_replace are zijn $line]
  set line [bMotion_module_extra_dutchify_single_word_replace "reserved sign" "gereserveerd bordje" $line]
  set line [bMotion_module_extra_dutchify_single_word_replace "to be" zijn $line]
  set line [bMotion_module_extra_dutchify_single_word_replace no nee $line]
  set line [bMotion_module_extra_dutchify_single_word_replace {is (.+)} {\1 is} $line]
  set line [bMotion_module_extra_dutchify_single_word_replace he hij $line]
  set line [bMotion_module_extra_dutchify_single_word_replace of van $line]
  set line [bMotion_module_extra_dutchify_single_word_replace the de $line]
  set line [bMotion_module_extra_dutchify_single_word_replace this dit $line]
  set line [bMotion_module_extra_dutchify_single_word_replace at in $line]
  set line [bMotion_module_extra_dutchify_single_word_replace on op $line]
  set line [bMotion_module_extra_dutchify_single_word_replace and en $line]
  set line [bMotion_module_extra_dutchify_single_word_replace has heeft $line]
  set line [bMotion_module_extra_dutchify_single_word_replace yes ja $line]
  set line [bMotion_module_extra_dutchify_single_word_replace how hoe $line]
  set line [bMotion_module_extra_dutchify_single_word_replace who wie $line]
  set line [bMotion_module_extra_dutchify_single_word_replace they zij $line]
  set line [bMotion_module_extra_dutchify_single_word_replace do doe $line]
  ...
  set line [string map -nocase { "to be or not too be that is the question" "te zijn of niet te zijn, dat is de vraag" question vraag chicken kip hello hoi line lijn my mijn have heb nice leuke name naam stolen gestolen want wil must moet hugs knuffelt hug knuffel yes ja thanks dank} $line ]
