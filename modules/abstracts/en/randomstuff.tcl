...
bMotion_abstract_register "randomStuff" {
	...
	"Resistance if futile, you will be %VAR{sillyVerbs:past}"
	...
	"when this %VAR{sillyThings} hits %NUMBER{10000} mph, we're going to see some serious shit"
	...
	"My hovercraft is full of %VAR{sillyThings:plural}"
